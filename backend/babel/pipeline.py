...
def translate_idml(
    ...
    report = {
        ...
        "note": "PDF is a draft preview (no InDesign). Open the .idml in InDesign "
                "(or run babel.idml.export) for a faithful PDF + INDD.",
    }
...
def translate_links_folder(
    ...
    graphic found inside an `.idml` (`babel.idml.graphics.translate_graphic`);
    ...
    from babel.idml.graphics import _content_hash, translate_graphic
