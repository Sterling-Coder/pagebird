...
class Language:
    ...
    glossary: str | None = None  # filename in pagebirdy/glossary/
...
# pagebirdy/fonts/README.md) so output does not depend on what the host OS happens
...
# Client-supplied Adobe Arabic (pagebirdy/fonts/AdobeArabic-*.otf) does NOT shape
...
LANGUAGES: dict[str, Language] = {
    ...
    "nl": Language("nl", "Dutch", "Dutch (nl-NL)", deepl="NL", fonts=_LATIN),
    "sv": Language("sv", "Swedish", "Swedish (sv-SE)", deepl="SV", fonts=_LATIN),
    "da": Language("da", "Danish", "Danish (da-DK)", deepl="DA", fonts=_LATIN),
    "nb": Language("nb", "Norwegian", "Norwegian Bokmål (nb-NO)", deepl="NB", fonts=_LATIN),
    "fi": Language("fi", "Finnish", "Finnish (fi-FI)", deepl="FI", fonts=_LATIN),
    "ro": Language("ro", "Romanian", "Romanian (ro-RO)", deepl="RO", fonts=_LATIN),
    "cs": Language("cs", "Czech", "Czech (cs-CZ)", deepl="CS", fonts=_LATIN),
    "sk": Language("sk", "Slovak", "Slovak (sk-SK)", deepl="SK", fonts=_LATIN),
    "hu": Language("hu", "Hungarian", "Hungarian (hu-HU)", deepl="HU", fonts=_LATIN),
    "tr": Language("tr", "Turkish", "Turkish (tr-TR)", deepl="TR", fonts=_LATIN),
    "id": Language("id", "Indonesian", "Indonesian (id-ID)", deepl="ID", fonts=_LATIN),
    "el": Language("el", "Greek", "Greek (el-GR)", latin_script=False, deepl="EL", fonts=_LATIN),
    "ru": Language("ru", "Russian", "Russian (ru-RU)", latin_script=False, deepl="RU", fonts=_LATIN),
    "uk": Language("uk", "Ukrainian", "Ukrainian (uk-UA)", latin_script=False, deepl="UK", fonts=_LATIN),
    "bg": Language("bg", "Bulgarian", "Bulgarian (bg-BG)", latin_script=False, deepl="BG", fonts=_LATIN),
    "et": Language("et", "Estonian", "Estonian (et-EE)", deepl="ET", fonts=_LATIN),
    "lt": Language("lt", "Lithuanian", "Lithuanian (lt-LT)", deepl="LT", fonts=_LATIN),
    "lv": Language("lv", "Latvian", "Latvian (lv-LV)", deepl="LV", fonts=_LATIN),
    "sl": Language("sl", "Slovenian", "Slovenian (sl-SI)", deepl="SL", fonts=_LATIN),
    "hr": Language("hr", "Croatian", "Croatian (hr-HR)", fonts=_LATIN),
    "ms": Language("ms", "Malay", "Malay (ms-MY)", fonts=_LATIN),
    "sw": Language("sw", "Swahili", "Swahili (sw-KE)", fonts=_LATIN),
    "af": Language("af", "Afrikaans", "Afrikaans (af-ZA)", fonts=_LATIN),
    "ca": Language("ca", "Catalan", "Catalan (ca-ES)", fonts=_LATIN),
