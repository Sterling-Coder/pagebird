...
helpers. CLI: `python -m pagebirdy.eval --help`.
...
from pagebirdy.eval.runner import (
    evaluate_idml_pair,
    evaluate_job,
    evaluate_pdf_pair,
    freeze_gold,
)
from pagebirdy.eval.scorecard import GATES, layout_score, render_markdown, run_gates
