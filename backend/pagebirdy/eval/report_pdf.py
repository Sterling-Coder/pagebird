...
from pagebirdy import languages  # noqa: F401  (used for the spelled-out language name)
...
def build_html(result: dict) -> str:
    ...
    from pagebirdy.eval.scorecard import _stamp
    ...
    from pagebirdy.eval.scorecard import GATES as _GATES
