...
from pagebirdy.models import Line
    ...
    try:
        ...
        for pno, page_lines in sorted(by_page.items()):
            ...
            for cluster in clusters:
                ...
                from pagebirdy.protect.latex_builder import is_fraction_bar
...
def recognise(pdf_path: str, regions: list[EquationRegion], out_dir: str,
    ...
    for region in regions:
        ...
        if engine == "structural":
            from pagebirdy.protect.latex_builder import build_latex, latex_confidence
